 ...
 */
char *Utility::dupString(char *origString)
{
...
char *Utility::catString2(char *origString1, char *origString2)
{
...
float Utility::mapf(float val, float in_min, float in_max, float out_min, float out_max)
{
